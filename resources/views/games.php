...
<head>
    ...
    <link rel="stylesheet" href="<?= config('app.public_path') ?>assets/vendor/datatables/css/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="<?= config('app.public_path') ?>assets/vendor/datatables/css/buttons.bootstrap4.css">
    <link rel="stylesheet" href="<?= config('app.public_path') ?>assets/vendor/datatables/css/select.bootstrap4.css">
    <link rel="stylesheet" href="<?= config('app.public_path') ?>assets/vendor/datatables/css/fixedHeader.bootstrap4.css">
...
<body>
                            ...
                            <div class="page-header">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div style="gap: 20px" class="d-flex align-items-center g-3 gap-3 justify-content-center">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control filter-input" id="filter-service" name="service">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control filter-input" id="filter-agency" name="campaign-chooser">
                                                <option value="all" selected>All</option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="gap: 10px" class="form-group d-flex align-items-end">
                                                <input class="form-control filter-input" type="date" data-date="<?php echo $date['initial'] ?>" id="filter-start-date" name="from" />
                                                <input class="form-control filter-input" type="date" data-date="<?php echo $date['final'] ?>" id="filter-end-date" name="to" />
                                ...
                                <div class="page-breadcrumb d-flex justify-content-between">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Games</a></li>
                    ...
                    <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="d-flex card-header align-items-center justify-content-between">
                                        <h5>Games</h5>
                                        <a href="#" class="btn btn-primary float-right">Add More</a>
                                    </div>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Service ID</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php 
    ...
    <script src="<?= config('app.public_path') ?>assets/vendor/datatables/js/dataTables.bootstrap4.min.js"></script>
    <script src="https://cdn.datatables.net/buttons/1.5.2/js/dataTables.buttons.min.js"></script>
    <script src="<?= config('app.public_path') ?>assets/vendor/datatables/js/buttons.bootstrap4.min.js"></script>
    <script src="<?= config('app.public_path') ?>assets/vendor/datatables/js/data-table.js"></script>
