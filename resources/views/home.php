...
<body>
    ...
    <script>
        ...
        var revenueArr = <?php echo json_encode(get_interval_data('transactions_tb', 'amount', [['column'=> 'amount', 'operator' => '>', 'value'=> 1]], 'day', 7, 'mysql2', 't_date', false )) ?>;
        var subsArr = <?php echo json_encode(get_interval_data('transactions_tb', 'amount', [['column'=> 'amount', 'operator' => '>', 'value'=> 1],['column'=> 'charges_status', 'value'=> 'Success'], ['column'=> 'bearer_id', 'value'=> 'SecureD']], 'day', 7, 'mysql2', 't_date', true, )) ?>;
        var unSubArr = <?php echo json_encode(get_interval_data('transactions_tb', 'amount', [['column' => 'charges_status', 'operator' => '=', 'value'=>'You deactivate the service successfully.']], 'day', 7, 'mysql2', 't_date', true )) ?>;
        var subRevArr = <?php echo json_encode(get_interval_data('transactions_tb', 'amount', [['column'=> 'amount', 'operator' => '>', 'value'=> 1],['column'=> 'charges_status', 'value'=> 'Success'], ['column'=> 'bearer_id', 'operator'=> '<>', 'value'=> 'system-renewal']], 'day', 7, 'mysql2', 't_date', )) ?>;
        var renRevArr = <?php echo json_encode(get_interval_data('transactions_tb', 'amount', [['column'=> 'amount', 'operator' => '>', 'value'=> 1],['column'=> 'charges_status', 'value'=> 'Success'], ['column'=> 'bearer_id', 'operator'=> '=', 'value'=> 'system-renewal']], 'day', 7, 'mysql2', 't_date', )) ?>;
    </script>
